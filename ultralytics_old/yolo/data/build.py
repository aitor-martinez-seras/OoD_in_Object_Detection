...
from .dataset import YOLODataset, FilteredYOLODataset
...
# TAO dataset
def build_filtered_yolo_dataset(cfg, img_path, batch, data, mode='train', rect=False, stride=32):
    """Build YOLO Dataset"""
    return FilteredYOLODataset(
        img_path=img_path,
        imgsz=cfg.imgsz,
        batch_size=batch,
        augment=mode == 'train',  # augmentation
...
# TAO dataset
def build_tao_dataset(cfg, img_path, batch, data, mode='train', rect=False, stride=32):
    """Build YOLO Dataset"""
    return TAODataset(
        img_path=img_path,
        imgsz=cfg.imgsz,
