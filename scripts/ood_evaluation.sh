...
python ood_evaluation.py --conf_thr 0.15 --tpr_thr 0.95 --ind_dataset owod --ind_split train --owod_task_ind t1 --ood_dataset coco_mixed --ood_split val --owod_task_ood all_task_test --device 3 --ood_method Cosine_cl_stride --compute_metrics --model_path runs_OWOD/20240313_1407_owod_t1_yolov8l_from_scratch/weights/best.pt
